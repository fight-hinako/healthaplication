...
>
    <div class="p-5 pb-3 shrink-0">
        <h2 class="text-lg font-semibold font-bold">今日の成果</h2>
    </div>
    <div class="flex flex-col items-start gap-3 px-5 pb-5">
        <p class="text-xl font-bold tabular-nums">
            今日のストレッチ回数:
            <span id="goals-completed-display" class="text-xl font-bold tabular-nums">{{ $completedTasks }}/{{ $dailyTasks }}</span>
        </p>

        <p class="text-xl font-bold tabular-nums">
            総作業時間:
            <span id="goals-total-time-display" class="text-xl font-bold tabular-nums">0分</span>
        </p>
    </div>
</div>
